...
(function( root, factory ) {
    ...
    define('runtime/runtime',[
        ...
        $.extend( Runtime.prototype, {
            ...
            getContainer: function() {
                ...
                if (parent[0].nodeName === 'BODY') {         // iowen 修改，解决父级错误的问题
                    parent = $(opts.id);
                    opts.container = parent
                    console.log('请刷新页面！');
                }
                container.addClass('webuploader-input-box'); // iowen 修改，解决按钮不可点击的问题
    ...
    define('lib/filepicker',[
        ...
        FilePicker.options = {
            ...
            accept: null,
            name: 'file',
            style: ''// 'webuploader-pick'   //default is "webuploader-pick" iowen 没啥用，注释掉
        };
        ...
        Base.inherits( RuntimeClient, {
            ...
            init: function() {
                ...
                /*$( window ).on( 'resize', this._resizeHandler );*/ // iowen 没啥用，注释掉
            },
    ...
    define('widgets/validator',[
        ...
        api.addValidator( 'fileNumLimit', function() {
            ...
            uploader.on( 'fileDequeued', function() {
                count = Math.max(0, --count);// iowen 修改.解决第2次上传时,文件数量超出限制的问题
            });
    ...
    define('runtime/html5/filepicker',[
        ...
        return Html5Runtime.register( 'FilePicker', {
            init: function() {
                ...
                // input.attr( 'capture', 'camera'); // iowen 删除直接调用摄像头
