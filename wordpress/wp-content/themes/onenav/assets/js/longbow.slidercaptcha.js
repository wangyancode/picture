(function () {
    ...
    _proto.initDOM = function () {
        ...
        canvas.className = 'captcha-body-bg';
...
function SliderCaptchaOpen(_btn) {
    ...
    if (!$('#' + modal_id).length) {
        var modal_html = '<div id="' + modal_id + '" class="modal fade" tabindex="-1" role="dialog" aria-hidden="false" style="user-select:none;z-index:100000000;background:rgba(0, 0, 0, 0.5);">\
                            ...
                            <div class="d-flex align-items-center"><div class="text-xs text-muted">© '+IO.sitesName+'</div><div class="slider-captcha-close ml-auto" data-dismiss="modal" aria-label="Close"><i class="iconfont icon-close"></i></div>\
                        </div></div></div></div></div>';
        ...
        setTimeout(function () {
            ...
            sliderCaptcha({
                ...
                setSrc: function () {
                    ...
                    return IO.uri + '/assets/images/captcha/' + window.captcha.imgId + '.jpg';
                },
                reset: function () {
                    window.captcha.imgId = false;
                },
