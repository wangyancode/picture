 ...
 *
 */
if ( ! class_exists( 'IOCF_Field_select' ) ) {
  class IOCF_Field_select extends IOCF_Fields {
    ...
    public function render() {
      ...
      if(wp_is_mobile() && $args['chosen']){
        echo '<div class="csf-before-text">注意：此选项只支持PC端设置。</div>';
      }
      ...
      if ( isset( $this->field['options'] ) ) {
        ...
        if ( ! empty( $args['ajax'] ) ) {
          ...
          $args['settings']['data']['nonce'] = wp_create_nonce( 'iocf_chosen_ajax_nonce' );
