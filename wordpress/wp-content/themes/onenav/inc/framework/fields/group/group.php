 ...
 *
 */
if ( ! class_exists( 'IOCF_Field_group' ) ) {
  class IOCF_Field_group extends IOCF_Fields {
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<div class="csf-cloneable-item csf-cloneable-hidden" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
          ...
          foreach ( $this->field['fields'] as $field ) {
            ...
            IOCF::field( $field, $field_default, '___'. $field_unique, 'field/group' );
          ...
          foreach ( $this->value as $value ) {
            ...
            if ( ! empty( $title_by ) ) {
              ...
              foreach ($title_by as $title_key) {
                if (isset($value[$title_key])) {
                  if (is_array($value[$title_key])) {
                    $titles[] = reset($value[$title_key]);
                  } else {
            ...
            echo '<div class="csf-cloneable-item">';
              ...
              foreach ( $this->field['fields'] as $field ) {
                ...
                IOCF::field( $field, $field_value, $field_unique, 'field/group' );
