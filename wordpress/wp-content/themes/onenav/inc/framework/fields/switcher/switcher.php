 ...
 *
 */
if ( ! class_exists( 'IOCF_Field_switcher' ) ) {
  class IOCF_Field_switcher extends IOCF_Fields {
    ...
    public function render() {
      ...
      $text_on    = ( ! empty( $this->field['text_on'] ) ) ? $this->field['text_on'] : esc_html__( '◯', 'csf' );
      $text_off   = ( ! empty( $this->field['text_off'] ) ) ? $this->field['text_off'] : esc_html__( '－', 'csf' );
      ...
      echo '<div class="clear"></div>';// 解决浮动问题
