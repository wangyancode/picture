 ...
 *
 */
if ( ! class_exists( 'IOCF_Field_icon' ) ) {
  class IOCF_Field_icon extends IOCF_Fields {
    ...
    public function render() {
      ...
      $nonce  = wp_create_nonce( 'iocf_icon_nonce' );
    ...
    public function enqueue() {
      add_action( 'admin_footer', array( 'IOCF_Field_icon', 'add_footer_modal_icon' ) );
      add_action( 'customize_controls_print_footer_scripts', array( 'IOCF_Field_icon', 'add_footer_modal_icon' ) );
    }
          ...
          <div class="csf-modal-table-cell">
            ...
            <div class="csf-modal-inner">
              <div class="csf-modal-title">
                ...
                <a href="https://www.iotheme.cn/one-nav-yidaohangzhutishiyongaliyuntubiaodefangfa.html" target="_blank" class="but b-blue" style="font-size:12px;font-weight:normal;padding:2px 5px;margin:0 0 0 5px;">图标库扩展教程</a>
