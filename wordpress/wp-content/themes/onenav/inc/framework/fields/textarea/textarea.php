 ...
 *
 */
if ( ! class_exists( 'IOCF_Field_textarea' ) ) {
  class IOCF_Field_textarea extends IOCF_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( IOCF::$shortcode_instances ) ) ? IOCF::$shortcode_instances : array();
