 ...
 *
 */
if ( ! class_exists( 'IOCF_Widget' ) ) {
  class IOCF_Widget extends WP_Widget {
    ...
    public function __construct( $key, $params ) {
      ...
      // Set filters
      $widget_ops  = apply_filters( "iocf_{$this->unique}_widget_ops", $widget_ops, $this );
      $control_ops = apply_filters( "iocf_{$this->unique}_control_ops", $control_ops, $this );
    ...
    public function form( $instance ) {
      ...
      if ( ! empty( $this->args['fields'] ) ) {
        ...
        foreach ( $this->args['fields'] as $field ) {
          ...
          IOCF::field( $field, $this->get_widget_value( $instance, $field ), $field_unique );
