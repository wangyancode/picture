 ...
 *
 */
if ( ! class_exists( 'IOCF_Abstract' ) ) {
  #[AllowDynamicProperties]
  abstract class IOCF_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        IOCF::$css = apply_filters( "iocf_{$this->unique}_output_css", IOCF::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'IOCF_Field_' . $field_type;
