 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Panel_IOCF' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class WP_Customize_Panel_IOCF extends WP_Customize_Panel {
    public $type = 'csf';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Section_IOCF' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_IOCF extends WP_Customize_Section {
    public $type = 'csf';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Control_IOCF' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_IOCF extends WP_Customize_Control {
    ...
    public function render_field_content() {
      ...
      $complex = apply_filters( 'iocf_customize_complex_fields', array(
        'accordion',
        'background',
        'border',
        'button_set',
      ...
      IOCF::field( $this->field, $this->value(), $this->unique, 'customize' );
