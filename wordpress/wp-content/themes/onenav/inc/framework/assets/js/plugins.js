...
(function($) {
  ...
  function IOCFAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  IOCFAjaxChosen.prototype.init = function() {
  ...
  IOCFAjaxChosen.prototype.events = function() {
  ...
  IOCFAjaxChosen.prototype.search_field_focused = function() {
  ...
  IOCFAjaxChosen.prototype.search_welcome_message = function() {
  ...
  IOCFAjaxChosen.prototype.update_list = function() {
  ...
  IOCFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      this.element.IOCFChosenOrder($hidden_value, true);
  ...
  $.fn.IOCFAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new IOCFAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, IOCFAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  IOCFAbstractChosenOrder = (function() {

    function IOCFAbstractChosenOrder() {}

    IOCFAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    IOCFAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    IOCFAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    IOCFAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    IOCFAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    IOCFAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    IOCFAbstractChosenOrder.IOCFChosenOrder = function(select, order, force) {
    ...
    return IOCFAbstractChosenOrder;
  ...
  $.fn.extend({
    IOCFChosenOrder: function(order, force) {
      return _IOCFChosenOrder.IOCFChosenOrder(this, order, force);
    }
  });

  this._IOCFChosenOrder = (function(_super) {
    __extends(_IOCFChosenOrder, _super);

    function _IOCFChosenOrder() {
      _ref = _IOCFChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _IOCFChosenOrder.relAttributeName = 'data-option-array-index';

    _IOCFChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _IOCFChosenOrder.getDOMElement = function(element) {
    ...
    _IOCFChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _IOCFChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _IOCFChosenOrder;

  })(IOCFAbstractChosenOrder);
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectIOCF = FormSerializer.serializeObject;
    $.fn.serializeJSONIOCF   = FormSerializer.serializeJSON;
  }
